...
class HosltedaMetrics(Metric):
    ...
    def __get_final_result(self):
        ...
        try:
            self.__program_difficulty = (len(self.__unique_operators) / 2) * (
                self.__total_operands / len(self.__unique_operands))
