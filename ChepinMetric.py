...
class ChepinMetric(Metric):
        ...
        def __get_final_result(self):
            ...
            self.__find_all_m()
            self.__find_all_t()
            result = self.A1 * self.__p + self.A2 * self.__m + self.A4 * self.__t
            return result
